...
class HydraMultivariate(nn.Module):
    ...
    def __init__(self, input_length, num_channels, k = 16, g = 128, max_num_channels = 8): #k and g can be updated fopr ablation
...
for fold, (train_idx, test_idx) in enumerate(
    ...
    ) #Change to different regressor for Ablation
    # Random Forest
